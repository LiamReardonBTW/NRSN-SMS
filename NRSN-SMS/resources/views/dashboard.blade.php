<x-app-layout>
    ...
    <h1 class="mx-6 text-2xl font-medium text-gray-900">
        Welcome <span class="text-green-600 font-bold">{{ Auth::user()->first_name }}</span>!
    </h1>


    {{-- Worker Dash Content --}}
    <h1 class="text-2xl text-blue-500 font-bold mx-6 mt-5">Worker</h1>
    <div
    ...
    <h1 class="text-2xl text-orange-500 font-bold mx-6 mt-5">Manager</h1>
    <div
        class="grid px-4 pt-4 lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-3 grid-cols-2 lg:gap-6 md:gap-6 sm:gap-s-6 gap-4">
    ...
    {{-- Admin Dash Content --}}
    <h1 class="text-2xl text-red-500 font-bold mx-6 mt-5">Admin</h1>
    <div
