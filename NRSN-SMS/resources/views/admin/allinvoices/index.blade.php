        ...
        <div class="relative overflow-auto border-2 border-blue-600 rounded mx-5"
            ...
            <table class="w-full text-left text-gray-800 bg-gray-100">
                ...
                <tbody class="text-sm font-bold">
                    ...
                    @foreach ($allClientInvoices as $invoice)
                        ...
                        <td class="grid grid-cols-2 text-xs text-white font-bold float-right py-2">
                            <div class="flex">
                                <!-- View Invoice Button -->
                            ...
                            @if ($invoice->status === 'pending')
                                <form method="POST" action="{{ route('markInvoiceAsPaid', ['id' => $invoice->id]) }}">
                                    @csrf
                                    <button type="submit"
