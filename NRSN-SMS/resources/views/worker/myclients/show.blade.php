<x-app-layout>
    <x-slot name="header">
        Client: {{ $myclient->first_name }} {{ $myclient->last_name }}
                ...
                <div class="text-2xl font-medium  overflow-hidden grid grid-cols-1 md:grid-cols-3  px-6 lg:px-8">
                    ...
                    <div class="mx-4 my-5">
                        ...
                        <x-input disabled type="text" name="invoicing_codes" id="invoicing_codes"
                            ...
                            value="{{ $myclient->invoicing_codes }}" />
                    </div>
                </div>
                ...
                <div class="text-2xl font-medium  overflow-hidden grid grid-cols-1 md:grid-cols-3  px-6 lg:px-8">
                    ...
                    <div class="mx-4 my-5">
                        ...
                        <x-input disabled type="text" name="active" id="active"
                            class="form-input rounded-md shadow-sm block w-full"
                            value="{{ $myclient->active ? 'Active' : 'Inactive' }}" />
                    </div>
